...
const WatchLater = ()=>{
        ...
        return(
            ...
            <div className="flex w-full relative">
                ...
                <div className="font-bold text-xl mx-12 mt-[1rem] w-8/12 ">
                    <p >{singleVideo?.snippet?.title}</p>
                </div>
                <div className="flex flex-row w-full border-black ml-10 p-2">
                    <div className="flex flex-row items-center mr-64">
                        <div>
                        ...
                        <div className="flex flex-col">
                            ...
                            <p className="text-sm text-gray-700 ">{countToDisplaycount(channelData?.statistics?.subscriberCount)}</p>
                        </div>
                        <div className="ml-5">
                    ...
                    <div className="flex flex-row ">
                        <div className="w-[10rem]">
                            <div className="flex hover:bg-gray-300  bg-slate-200 border-black p-2 rounded-3xl mr-5">
                                ...
                                <span className="mx-1 font-semibold">{singleVideo?.statistics?.likeCount ? countToDisplaycount(singleVideo?.statistics?.likeCount) : countToDisplaycount(channelData?.statistics?.videoCount) }</span>
            ...
            <div className="w-full mt-[3.5rem]">
                        {/* <Livechat/> */}
                        {singleVideo?.snippet?.categoryId && <SideVideos id = {singleVideo?.snippet?.categoryId}/>}
            </div>
            </div>
            </div>
        )
